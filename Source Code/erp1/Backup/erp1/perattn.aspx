<%@ Page Title="" Language="C#" MasterPageFile="~/Aveg.Master" AutoEventWireup="true" CodeBehind="perattn.aspx.cs" Inherits="erp1.perattn" %>
...
<form id="form1" runat="server">
    ...
    <h3 style="margin-bottom:10px; background-color:#99FFCC; width:1200px; color:Black; font-weight:bold; border:2px solid navy;"><marquee>Birla Institute Of Technology</marquee></h3>
    ...
    <br />
     ...
     <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Wrap="True" Height="390px">
        ...
        <td style="border-color:Navy; border-width:2px; border-style:solid; font-weight:bold; color:Navy;" width="400px">Total Attendance</td>
   ...
   <% 
      ...
      String b = Request.QueryString["sem"];
       ...
       ad.Fill(ds);
       SqlDataAdapter ad1 = new SqlDataAdapter("select * from attendance where rno='"+Session["id"]+"' and extra='NO'", "server=B1aZe;database=erp;integrated security=true");
       ...
       for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
       {
           for (int j = 0; j < ds1.Tables[0].Rows.Count; j++)
           {
               ...
               if (ds1.Tables[0].Rows[j][7].ToString()==ds.Tables[0].Rows[i][0].ToString())
               {
                   ...
                   attn = attn + Convert.ToInt32(ds1.Tables[0].Rows[j][3]);
                   tot = tot + Convert.ToInt32(ds1.Tables[0].Rows[j][9]);
               }
           }
       %>
   <tr>
   ...
   <td style="border-color:Navy; border-width:2px; border-style:solid; font-weight:bold; color:White;" width="400px"><%=attn %>(<%=tot %>)</td>
