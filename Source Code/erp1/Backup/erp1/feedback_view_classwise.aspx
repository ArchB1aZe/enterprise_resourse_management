<%@ Page Title="" Language="C#" MasterPageFile="~/Aveg.Master" AutoEventWireup="true" CodeBehind="feedback_view_classwise.aspx.cs" Inherits="erp1.feedback_view_classwise" %>
...
<form id="form1" runat="server">
    ...
    <td  align="center" 
     ...
     <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Wrap="True" Height="390px">
        ...
        <td style="border-color:Black; border-width:2px; border-style:solid; font-weight:bold; color:White;" width="300px">Subject</td>
       
                
        <td style="border-color:Black; border-width:2px; border-style:solid; font-weight:bold; color:White;" width="300px">Faculty</td>
      ...
      <%
          ...
          SqlDataAdapter ad1 = new SqlDataAdapter("select * from subject where branch='" + a + "' and sem='" + b + "'", "server=B1aZe;database=erp;integrated security=true");
          ...
          {
              SqlDataAdapter ad = new SqlDataAdapter("select * from feedback where sid='" + ds1.Tables[0].Rows[i][0] + "' and branch='" + a + "'", "server=B1aZe;database=erp;integrated security=true");
        ...
        <td style="border-color:Black; border-width:2px; border-style:solid; font-weight:bold; color:White;" width="300px"><%=ds1.Tables[0].Rows[i][1] %></td>
        <td style="border-color:Black; border-width:2px; border-style:solid; font-weight:bold; color:White;" width="300px"><%=ds.Tables[0].Rows[0][12] %></td>
