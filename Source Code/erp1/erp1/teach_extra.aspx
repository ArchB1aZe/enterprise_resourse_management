<%@ Page Title="" Language="C#" MasterPageFile="~/Aveg.Master" AutoEventWireup="true" CodeBehind="teach_extra.aspx.cs" Inherits="erp1.teach_extra" %>
...
<form id="form1" runat="server">
    ...
    <tr style="border:0px; font-size:larger">
     ...
     <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Wrap="True" Height="390px">
        ...
        <td style="border-color:Navy; border-width:2px; border-style:solid; font-weight:bold; color:Navy;" width="400px">Roll Number</td>
        <td style="border-color:Navy; border-width:2px; border-style:solid; font-weight:bold; color:Navy;" width="200px">
            Attendance</td>
        ...
        <% 
           ...
           int att = 0;
           double atten = 0;
            SqlDataAdapter ad = new SqlDataAdapter("select * from attendance where scode='" + d + "' and extra='YES'", "server=B1aZe;database=erp;integrated security=true");
      ...
      DataSet ds = new DataSet();
       ...
       for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
       {
        ...
        <td style="border-color:Navy; border-width:2px; border-style:solid; font-weight:bold; color:White;" width="400px"><%=ds.Tables[0].Rows[i][0] %></td>
