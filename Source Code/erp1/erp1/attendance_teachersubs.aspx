<%@ Page Title="" Language="C#" MasterPageFile="~/Aveg.Master" AutoEventWireup="true" CodeBehind="attendance_teachersubs.aspx.cs" Inherits="erp1.attendance_teachersubs" %>
...
<form id="form1" runat="server">
    ...
    <h1 style="background-color:White; padding-left:30px; margin-top:10px; padding-top:17px; font-family:Comic Sans MS; height:100px;  font-size:50px; border:2px solid navy; color:Navy; font-weight:bold;">ATTENDANCE</h1>
