<%@ Page Title="" Language="C#" MasterPageFile="~/Aveg.Master" AutoEventWireup="true" CodeBehind="marks_endenter.aspx.cs" Inherits="erp1.marks_endenter" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <td valign="middle" align="center" style="font-size:xx-large; color:Black; font-weight:bold; padding-top:15px; font-family:Comic Sans MS;" width="1200px" height="60px">ENTER 
        END-SEM MARKS</td>
    </tr>
    </table>
    ...
    <asp:Table ID="tb" runat="server" BackColor="White" BorderColor="Black" BorderStyle="Solid" BorderWidth="2px" ForeColor="Black">
           <asp:TableRow ID="TableRow1" Runat="server" Font-Bold="True"
            ForeColor="Black" BackColor="Silver" BorderColor="Black" BorderStyle="Solid" BorderWidth="2px" Font-Size="Large">
              ...
              <asp:TableHeaderCell Width="300px" BorderColor="Black" BorderStyle="Solid" BorderWidth="2px">Marks(MM:60)</asp:TableHeaderCell>
              </asp:TableRow>
         </asp:Table>
    </asp:Panel>
